#This funtion ingests data in bulk incase you need to populate the database fast to test other components

# When using it change the mongo db database, the astra collection and the the kafka connector on confluent to test versions
